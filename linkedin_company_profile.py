...
class LinkedCompanySpider(scrapy.Spider):
    ...
    api_url = 'https://www.linkedin.com/jobs-guest/jobs/api/seeMoreJobPostings/search?keywords=AI&location=australia&geoId=&trk=public_jobs_jobs-search-bar_search-submit&start=' 
