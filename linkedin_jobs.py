...
class LinkedJobsSpider(scrapy.Spider):
    name = "linkedin_jobs"
    api_url = 'https://www.linkedin.com/jobs/search?keywords=customer%20service&location=Australia&geoId=101452733&trk=public_jobs_jobs-search-bar_search-submit&position=1&pageNum='
    ...
    def parse_job(self, response):
        ...
        if num_jobs_returned > 0:
            first_job_on_page = int(first_job_on_page) + 50
